...
// Plass til tidslinjalen som ligger nederst på skjermen, pluss luft under.
export const RULER_H = 62;
export const RULER_BOTTOM_GAP = 56;
export const PAD_BOTTOM = RULER_H + RULER_BOTTOM_GAP + 70;
